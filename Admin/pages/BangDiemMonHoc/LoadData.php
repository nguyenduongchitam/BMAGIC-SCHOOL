...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo '<tr>
                <td class="text-center"><input name="btSelectItem" type="checkbox" value="0"></td>
                ...
                <td class="text-center">
                    <button style="background-color:transparent; border-width: 0; color:blue" type="button" class="btn btn-primary btn-Sua">
